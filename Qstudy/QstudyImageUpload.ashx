<%@ WebHandler Language="C#" Class="QstudyImageUpload" %>
...
public class QstudyImageUpload : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        Qry = @"INSERT INTO Tab_Mst_Photo(ImageName,Ext,UploadedSource,UploadedBy)
                VALUES(@ImageName,@Ext,@UploadedSource,@UploadedBy)
