<%@ Page Title="" Language="C#" MasterPageFile="~/Qstudy/MasterPageQstudy.master" AutoEventWireup="true" CodeFile="frmQChangeEventStatus.aspx.cs" Inherits="Qstudy_frmQChangeEventStatus" %>
...
.has-search .form-control-feedback {
    ...
    <script type="text/javascript">
     function BindGrid(SearchValue,RowPerPage, PageNumber) {
            ...
            $.ajax({
                type: "POST",
                url: "frmQChangeEventStatus.aspx/BindList",
                    ...
                    if (len > 0) {
                       ...
                       // $("#divTable").html(response.d);
                        for (var i = 0; i < len; i++) {
                            ...
                            //Data += "<td><a href='javascript:void(0);' id='" + Id + "' class='btn-sm btn-info viewData' style='display:inline' data-toggle='modal' onclick='return ViewDetails(this.id);' >View</a></td>";

                            if (response.d[i].Status == "Active") {
                                Data += "<td><a href='javascript:void();' onclick='return GetEditData(" + Id + ");' style='Background-color:green;color:white' title='Click here to change status !'>Active</a></td>";
                            }
                            else {
                                Data += "<td><a href='javascript:void();' onclick='return GetEditData(" + Id + ");'  style='Background-color:red;color:white' title='Click here to change status !'>Inactive</a></td>";
                            }
        ...
        function GetEditData(EventId) {
            ...
            $.ajax({
                type: "POST",
                url: "frmQChangeEventStatus.aspx/GetEditEventData",
