...
<!-- Latest compiled and minified CSS -->
    ...
    <link href="ARCss/bootstrap.min.css" rel="stylesheet" />
     <script src="ARCss/jquery.min.js"></script>
    <script src="ARCss/popper.min.js"></script>
    <script src="ARCss/bootstrap.min.js"></script>
...
<link href="https://fonts.googleapis.com/css2?family=Pragati+Narrow:wght@400;700&display=swap" rel="stylesheet"/>
    ...
    <script src="ARCss/intlTelInput.min.js"></script>
    <link href="ARCss/intlTelInput.min.css" rel="stylesheet" />
    <script src="ARCss/utils.js"></script>   
...
<section class="regis_section">
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
            ...
            <div class=" col-md-6 col-lg-6">
                        ...
                        <div class="row">
                         ...
                         <!-----code by Nidhi --> 
                                ...
                                <div>
                                 ...
                                 <img id="imgflag" src="#" style="display:none;float:left"/>
                                    </div><div style="float:left;width:7.5em;">
                                <input type="text" placeholder="+123" id="txtCountryNameFlag"  class="textboxAuto form-control" />
                               </div> </div>
               ...
               placeholder="Phone Number" style="display:none" />
                        ...
                        <div class="col-md-8 col-sm-8">
                           ...
                           <input class="form-control m_num numeric" id="txtno" placeholder="000 000 000 0000" maxlength="15"/>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                         ...
                         <select id="ddlCountry" class="form-control" onchange="BindSelctedCountryCode(this.value);"> </select>
                    ...
                    <input type="text" class="form-control" id="txtst" placeholder="city" name="neme" />
                       ...
                       <a href="javascript:void()" class="registration_btn"> 
                       <button type="button" class="btnn btnblue btn-block" onclick="gotoNextStep()">next</button></a>
                      </div>
                      ...
                      <label for="email">What fee range are you looking at? </label><sup><i class="fas fa-star-of-life mendet"></i></sup>
                        ...
                        <a href="javascript:void()" class="registration_btn">  
                            <button type="button" id="btnsave" class="btnn btnblue btn-block">
                                                    SUBMIT
    ...
    <input type="hidden" id="hdfRegId" value="0" />
...
<script type="text/javascript">
    ...
    function gotoNextStep() {
        ...
        var mobilecode = $('#txtCountryNameFlag').val();
    ...
    function SavePartialData() {
        ...
        $.ajax({
            type: "POST",
            url: "Registration.aspx/SavePartialData",
            data: "{'Gender':'" + Gender + "','name':'" + name + "','mobilecode':'" + mobilecode + "','phoneno':'" + phoneno + "','emailid':'" + emailid + "','Country':'" + Country + "','City':'" + City + "','Msg':'" + Msg + "','Msgid':'" + Msgid + "','RegId':'" + RegId + "'}",
    ...
    function SendOTPEmail() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "Registration.aspx/SendOTPEmail",
    ...
    function VerifyOTP() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "Registration.aspx/VerifyOTP",
    ...
    function ResendOTP() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "Registration.aspx/ResendOTP",
                data: "{'EmailID':'" + emailid + "'}",
                contentType: "application/json; charset=utf-8",
                success: function (response) {
                    if (response.d == 1) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function BindCountry() {
                $.ajax({
                    type: "POST",
                    url: "Registration.aspx/BindCountry",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        $("#ddlCountry").html(response.d);
 ...
 <%--       <link href="multiselectcssjs/bootstrap.min.css" rel="stylesheet" />--%>
    ...
    <script src="multiselectcssjs/bootstrap-multiselect.js"></script>
         <script type="text/javascript">
           ...
           $('#btnsave').click(function () {
               ...
               var ccode = $("#txtCountryNameFlag").val();
               ...
               $.ajax({
                   type: "POST",
                   url: "Registration.aspx/insertion",
   ...
   <%-- </form>--%>
    ...
    <link href="ARCss/jquery-ui.css" rel="stylesheet" />
    <script src="ARCss/jquery-ui.js"></script>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        $(function () {
            ...
            $('#txtCountryNameFlag').autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: "Registration.aspx/bindCountryFlag",
                ...
                select: function (event, ui) {
                    ...
                    $('#imgflag').attr('src', '/imgCountryFlag/' + ui.item.CountryFlag),
                        $('#ddlCountry').val(ui.item.CountryName),
                        $("#txtno").val(""),
                        $("#txtno").attr('maxlength', ui.item.MobileNoLength),
            ...
            function BindCurrentCountryCode() {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "Registration.aspx/GetCountryName",
                    data: "{}",
                    cache: false,
                    async: false,
                    dataType: "json",
                    success: function (data) {
                        ...
                        $("#txtCountryNameFlag").val(myData[0]["CountryMobCode"]),
                            ...
                            $('#ddlCountry').val(myData[0]["CountryName"]),
                            $("#txtno").val(""),
                            $("#txtno").attr('maxlength', myData[0]["MobileNoLength"]);
                    },
        ...
        function BindSelctedCountryCode(cName) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Registration.aspx/GetSelctedCountryCode",
                data: "{'CName':'" + cName+"'}",
                cache: false,
                async: false,
                dataType: "json",
        ...
        <!-- Modal body -->
         <div class="modal-body">
           <div class="row">
                       ...
                       <div class="col-lg-12" style="background-color:#28a745;color:white;">
                                    <label id="lblOtpMessage" >An OTP Sent To Your Email Id. Please Enter OTP To Verify Your Email Id !!</label>
                                </div>
            <br />
                        <div class="row">
                            <div class="col-lg-6">
                                <label  id="lblOtp"   class="form-label"> Enter OTP : </label>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row" style="margin-top:20px;"">
                            <div class="col-lg-6">
                                <input type="button"  id="btnVerify" value="Verify" style="background-color:#28a745;color:white;text-align:center !important;" class="btn btn-primary btn-lg"  onclick="VerifyOTP()" />
                            </div>
                             <div class="col-lg-6">
                                <input type="button" id="btnResendOtp" value="Resend" style="background-color:#17a2b8;color:white;text-align:center !important;" class="btn btn-primary btn-lg"   onclick="ResendOTP()" />
                            </div>
                        </div>
            </div>
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" style="background-color:#dc3545;color:white;text-align:center !important;" data-dismiss="modal">Close</button>
        </div>
