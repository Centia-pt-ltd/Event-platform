<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="SuperAdmin_login" %>
...
<!--<header class="main-header dark">
    ...
    <div class="nav">
       ...
       <div class="all_pages_wrappere" style="margin:0">
            <div class="login-page" style="height: calc(100vh - 0px);">
                <div class="bg_layer" style="height: calc(100vh - 0px);">
           <div class="mform">
