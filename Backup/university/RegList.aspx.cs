...
public partial class university_RegList : System.Web.UI.Page
{
   static string dbCon = ConfigurationManager.ConnectionStrings["conn"].ToString().Trim();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["UniversityName"] == null || Session["UniversityName"].ToString() == "")
            {
            ...
            else
            {
                ...
                bindGrid(Course, Qualification, Country);
            }
        }
    }

    public void bindGrid(string Course, string Qualification,string Country)
    {
        try
        {
