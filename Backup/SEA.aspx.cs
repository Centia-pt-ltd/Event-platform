    ...
    public static string insertion(string name, string gender, string ccode, string phoneno, string emailid, string country, string state, string txtscore, string msg, string msgid, string hq, string hqid, string course, string courseid, string Abroad, string Fee)
    {
        ...
        try
        {
            ...
            if (intresult != 0)
            {
               ...
               string mailid = "qstudyleads@kmi.world";
                MailMessage mail = new MailMessage();
                mail.To.Add(mailid);
                //mail.From = new MailAddress(emailid, name);
                mail.From = new MailAddress("qstudyleads@kmi.world", name);
                ...
                smtp.Port = 25;
                smtp.Host = "mail.kmi.world";
                smtp.Credentials = new System.Net.NetworkCredential("qstudyleads@kmi.world", "Qstudyleads@2021");
                //smtp.EnableSsl = true;
                smtp.Send(mail);
                mail.Dispose();               
                ...
                mail.Subject = "New Registration";
                string Url = "http://qstudyabroad.com/mailTemplate/SouthEastAsia.html";
