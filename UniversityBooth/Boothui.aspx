<%@ Page Title="" Language="C#" MasterPageFile="~/UniversityBooth/BoothMasterPage.master" AutoEventWireup="true" CodeFile="Boothui.aspx.cs" Inherits="UniversityBooth_Boothui" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <%--  <div class="university_booth_wrapper" style="margin-top:2%;">
           <div> <h2 class="bootcuname" id="universityName" runat="server" ></h2> </div></div>
     ...
     <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            function next(Uid, Pid) {
                location.href = "Boothui.aspx?Uid=" + Uid + "&Pid=" + Pid;
                return false;
            }
            ...
            function NextRecords() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Boothui.aspx/NextBoothDetail",
            ...
            function PrevRecords() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Boothui.aspx/PrevBoothDetail",
        ...
        function selectBoothDetail() {
            ...
            $.ajax({
                type: "POST",
                url: "Boothui.aspx/selectBoothDetail",
        ...
        function ViewBrochure() {
            ...
            $.ajax({
                type: "POST",
                url: "Boothui.aspx/BindBrichureList",
                data: "{'UniversityId':'" + UniversityId + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    ...
                    for (var k = 0; k < len; k++) {
                        ...
                        div += " <i class='fa fa-download' style='color: #09eaff;'></i><br/> <label style='cursor:pointer' onclick='downloadBrochure(" + response.d[k].Id + ");' for=" + Id + ">" + DisplayFileName + "</label><br></span>";
        ...
        function ViewVideo() {
            ...
            function videoCall() {
               ...
               // $("#divVideoCall").html('');
                $.ajax({
                    type: "POST",
                    url: "Boothui.aspx/CreateVideoChat",
            ...
            function videoCallMob() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        //div += " </iframe>";
                        //$("#divVideoCall").html(div);
                       // window.open(VideoUrl, 'Newwin', '_blank');
