...
public partial class university_AllBooth_Booth : System.Web.UI.Page
{
    ...
    public static ClsBoothBO[] selectBoothDetail(string UniId)
    {
        ...
        try
        {
            ...
            {
                string qr = "";
                qr = @"select Tab_University.UniversityName, BoothName, BoothPage, BoothImage, ImageBig,ImageSmall ";
                qr += "from Tab_University ";
                qr += "Inner Join Tab_MstBooth on Tab_MstBooth.Id=Tab_University.BoothId ";
