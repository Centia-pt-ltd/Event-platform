<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MENA.aspx.cs" Inherits="MENA" %>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function BindSelctedCountryCode(cName) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "MENA.aspx/GetSelctedCountryCode",
                data: "{'CName':'" + cName+"'}",
                cache: false,
                async: false,
                dataType: "json",
