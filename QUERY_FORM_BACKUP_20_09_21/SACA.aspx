<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SACA.aspx.cs" Inherits="SACA" %>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function BindSelctedCountryCode(cName) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "SACA.aspx/GetSelctedCountryCode",
                data: "{'CName':'" + cName+"'}",
                cache: false,
                async: false,
                dataType: "json",
