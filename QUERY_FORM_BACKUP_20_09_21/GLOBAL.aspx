<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GLOBAL.aspx.cs" Inherits="GLOBAL" %>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        $(function () {
            ...
            $('#txtCountryNameFlag').autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: "GLOBAL.aspx/bindCountryFlag",
            ...
            function BindCurrentCountryCode() {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "GLOBAL.aspx/GetCountryName",
                    data: "{}",
                    cache: false,
                    async: false,
                    dataType: "json",
        ...
        function BindSelctedCountryCode(cName) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "GLOBAL.aspx/GetSelctedCountryCode",
                data: "{'CName':'" + cName+"'}",
                cache: false,
                async: false,
                dataType: "json",
